 ...
 */
function getPasswordHash(#[\SensitiveParameter] $password): string
{
 ...
 * @return boolean
 */
function checkPassword(#[\SensitiveParameter] $password, $hash): bool
{
 ...
 */
function checkCSRFTokenForScript(#[\SensitiveParameter] $token, string $script): bool
{
