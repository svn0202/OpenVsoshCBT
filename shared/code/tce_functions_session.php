 ...
 */
function getLegacyClientFingerprint()
{
    $sid = K_RANDOM_SECURITY;
    if (isset($_SERVER['HTTP_USER_AGENT'])) {
        $sid .= $_SERVER['HTTP_USER_AGENT'];
 ...
 */
function getPlainCSRFTokenForScript(string $script)
{
 ...
 */
function checkCSRFTokenForScript(#[\SensitiveParameter] $token, string $script)
{
