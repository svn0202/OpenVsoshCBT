...
CREATE TABLE tce_tests (
	...
	test_results_publish_at Datetime NULL,
	test_results_unpublish_at Datetime NULL,
	test_results_anonymized Bool NOT NULL DEFAULT '0',
...
CREATE TABLE tce_tests_users (
	...
	Index idx_testuser_pregenerated (testuser_test_id,testuser_pregenerated,testuser_status),
...
CREATE TABLE tce_tests_logs (
	...
	testlog_reviewed Bool NOT NULL DEFAULT '0',
