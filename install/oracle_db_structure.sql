...
CREATE OR REPLACE TRIGGER tce_testlog_attachments_trigger BEFORE INSERT ON tce_testlog_attachments FOR EACH ROW BEGIN SELECT tce_testlog_attachments_seq.nextval INTO :new.attachment_id FROM DUAL; END;;
...
CREATE TABLE tce_tests_logs (
	...
	testlog_answer_saved_at DATE,
	testlog_reviewed NUMBER(1) DEFAULT 0 NOT NULL,
