...
CREATE TABLE "tce_tests" (
	...
	"test_results_publish_at" Timestamp,
	"test_results_unpublish_at" Timestamp,
	"test_results_anonymized" Boolean NOT NULL Default '0',
	...
	"test_live_score" Boolean NOT NULL Default FALSE,
	"test_auto_fullscreen" Boolean NOT NULL Default FALSE,
	"test_hide_exam_info" Boolean NOT NULL Default FALSE,
	"test_ai_trap_enabled" Boolean NOT NULL Default FALSE,
...
CREATE TABLE "tce_tests_logs" (
	...
	"testlog_reviewed" Boolean NOT NULL Default FALSE,
