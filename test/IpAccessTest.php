...
final class IpAccessTest extends TestCase
{
    ...
    {
        self::assertFalse(\F_isValidIP('', '192.0.2.1'));
        self::assertTrue(\F_isValidIP('2001:db8::10', '2001:DB8::10'));
        self::assertTrue(\F_isValidIP('192.0.2.10', '192.0.2.1-192.0.2.20'));
        self::assertFalse(\F_isValidIP('192.0.2.21', '192.0.2.1-192.0.2.20'));
    }
}
