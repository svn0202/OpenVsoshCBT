...
PHP;
    ...
    public function testUserTestCataloguePreservesEmptyAndBlockedResults(): void
    {
        ...
        self::assertStringContainsString('<th scope="col">From</th>', $results[3]);
        self::assertStringContainsString('<th scope="col">To</th>', $results[3]);
        self::assertStringContainsString('<th scope="col">Status</th>', $results[3]);
    ...
    public function testCreateTestPreservesLimitInsertFailureAndSuccessfulLifecycle(): void
    {
        [$status, $output] = \F_tcecode_run_process(
            [
                ...
                'namespace Harness; define("K_DATABASE_TYPE", "MYSQL"); '
                    ...
                    . '"tsubset_id" => "44", "tsubset_quantity" => "1", "tsubset_difficulty" => "3", '
                    . '"tsubset_type" => "0", "tsubset_answers" => "0"], false], '
                    . '"subjects" => [false], "questions" => [["question_id" => "101", '
                    . '"question_type" => "3", "question_difficulty" => "3", "question_position" => "1"], false]]; '
         ...
         *   5:list<list<mixed>>,6:list<list<mixed>>
         * } $decoded
         */
        $decoded = json_decode($output, true, 512, JSON_THROW_ON_ERROR);
        [$returns, $queries, $errors, $insertCalls, $statDates, $logCalls, $answerCalls] = $decoded;
        ...
        self::assertStringContainsString('LIMIT 1', $queries[7]);
        self::assertSame(
        ...
        self::assertSame([[55, '101', 6, 1, '0']], $logCalls);
        $expectedTestData = [
