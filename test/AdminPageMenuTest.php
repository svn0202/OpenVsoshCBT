...
final class AdminPageMenuTest extends TestCase
{
    public function testMenuStructureAndRoleMappingRemainUnchanged(): void
    {
        ...
        self::assertStringContainsString('["index.php",1,true,[]]', $output);
        self::assertStringContainsString(
            '["tce_menu_tests.php",1,true,["tce_test_access_rules.php","tce_monitor.php",',
            $output,
        );
        self::assertStringContainsString('["tce_logout.php",1,true,[]]', $output);
        self::assertStringContainsString('["tce_login.php",0,false,[]]', $output);
